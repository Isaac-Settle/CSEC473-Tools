...
sshpass -p "@rchitect_@rcane" ssh LCoramar@10.10.2.1 'powershell "Set-LocalUser -Name "LCoramar" -Password (ConvertTo-SecureString "f0xtr0t_w1nd0ws_PA55" -AsPlainText -Force)"; "Set-LocalUser -Name "bloodhunter" -Password (ConvertTo-SecureString "f0xtr0t_w1nd0ws_PA55" -AsPlainText -Force)"; "echo Vanguard > /system32/Grey-team/logbook.txt"; shutdown /r /t 0'

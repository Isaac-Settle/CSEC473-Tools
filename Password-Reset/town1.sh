...
sshpass -p "Guard!an_7th" ssh CAgrupnin@10.10.1.1 'powershell "Set-LocalUser -Name "CAgrupnin" -Password (ConvertTo-SecureString "f0xtr0t_w1nd0ws_PA55" -AsPlainText -Force)"; "echo Vangaurd > \system32\Grey-team\logbook.txt"; shutdown /r /t 0'
sshpass -p "alchemist" ssh artificer@10.10.1.1 'powershell "Set-LocalUser -Name "artificer" -Password (ConvertTo-SecureString "f0xtr0t_w1nd0ws_PA55" -AsPlainText -Force)"; "echo Vangaurd > \system32\Grey-team\logbook.txt"; shutdown /r /t 0'
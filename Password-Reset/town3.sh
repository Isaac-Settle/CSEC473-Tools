...
sshpass -p "H3ralds_Tom3" ssh LSeelie@10.10.3.1 'powershell "Set-LocalUser -Name "LSeelie" -Password (ConvertTo-SecureString "f0xtr0t_w1nd0ws_PA55" -AsPlainText -Force)"; "echo Vangaurd > /system32/Grey-team/logbook.txt"; shutdown /r /t 0'
sshpass -p "shadow" ssh monk@10.10.3.1 'powershell "Set-LocalUser -Name "monk" -Password (ConvertTo-SecureString "f0xtr0t_w1nd0ws_PA55" -AsPlainText -Force)"; "echo Vangaurd > /system32/Grey-team/logbook.txt"; shutdown /r /t 0'
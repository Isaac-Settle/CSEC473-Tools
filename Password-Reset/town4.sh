...
sshpass -p "B3tray3r_Gods" ssh VChloras@10.10.4.1 'powershell "Set-LocalUser -Name "VChloras" -Password (ConvertTo-SecureString "f0xtr0t_w1nd0ws_PA55" -AsPlainText -Force)"; "echo Vangaurd > /system32/Grey-team/logbook.txt"; shutdown /r /t 0'
sshpass -p "wild-magic" ssh sorcerer@10.10.4.1 'powershell "Set-LocalUser -Name "sorcerer" -Password (ConvertTo-SecureString "f0xtr0t_w1nd0ws_PA55" -AsPlainText -Force)"; "echo Vangaurd > /system32/Grey-team/logbook.txt"; shutdown /r /t 0'